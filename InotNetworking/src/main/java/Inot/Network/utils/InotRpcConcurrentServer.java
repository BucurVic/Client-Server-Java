...
public class InotRpcConcurrentServer extends AbsConcurrentServer
{
    private IInotServices InotServer;
    private static Logger logger = LogManager.getLogger(InotClientRpcReflectionWorker.class);
    public InotRpcConcurrentServer(int port, IInotServices inotServer) {
        super(port);
    ...
    protected Thread createWorker(Socket client) {
        InotClientRpcReflectionWorker worker=new InotClientRpcReflectionWorker(InotServer, client);
